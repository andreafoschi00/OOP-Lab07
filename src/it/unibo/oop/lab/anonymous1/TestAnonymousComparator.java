...
public final class TestAnonymousComparator {
    ...
    public static void main(final String... args) {
         ...
         */
        final var sortMethod = new Comparator<User>() {
        	public int compare(final User a, final User b) {
        		return Integer.compare(a.getAge(), b.getAge());
        	}
        };
        Collections.sort(denzelUsers, sortMethod);
        /*
         * expected Result
         */
         ...
         * class Collections
         */
        final var sortMethod2 = new Comparator<User>() {
        	public int compare(final User a, final User b) {
        		return Integer.compare(b.getAge(), a.getAge());
        	}
        };
        Collections.sort(rossiUsers, sortMethod2);
        /*
         * expected Result
         */
